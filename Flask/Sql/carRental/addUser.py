...
def add_user(*args):
    ...
    try:
        query = "INSERT INTO lyfter_car_rental.users (full_name, email, user_name, user_password, birthday) VALUES (%s, %s, %s, %s, %s) RETURNING *;"
...
if __name__ == "__main__":
    ...
    birthday = input("ingresa tu fecha de nacimineto (YYYY-MM-DD): ")

    add_user(full_name, email, user_name, user_password, birthday)
