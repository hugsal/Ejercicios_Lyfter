...
def add_car(*args):
    ...
    try:
        query = "INSERT INTO lyfter_car_rental.cars (make, model, car_year) VALUES (%s, %s, %s) RETURNING *;"
...
if __name__ == "__main__":
    ...
    car_year = input("ingresa el año del vehivulo: ")

    add_car(make, model, car_year)
