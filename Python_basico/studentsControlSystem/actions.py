...
def validate_if_student_already_exists(students, student):
    student_name_and_section = [
        f"{existing_student['name']} {existing_student['section']}"
        for existing_student in students
    ]
    if f"{student['name']} {student['section']}" in student_name_and_section:
        raise ValueError(f"{student['name'].title()} is already in the list")
...
def create_a_student(students, assignments):
    ...
    validate_if_student_already_exists(students, student)
    student["notes"] = get_notes(assignments)
